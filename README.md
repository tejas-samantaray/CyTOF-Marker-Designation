...
Did you forget to load the CyTOF aquiring template while recording your data? This script will allow you to re-designate the correct metal isotope tag (eg: 144Nd,  to the biological marker if this mistake happened so that various analysis softwares can recognize your FCS files (eg: MaxPar Pathsetter).
